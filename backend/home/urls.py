...
path("about/",views.reactapp,name="nilaya_about"),

path("news/",views.reactapp,name="nilaya_news"),

path("contactus/",views.reactapp,name="nilaya_contactus"),

path("resident/blogs/",views.reactapp,name="nilaya_blogs"),

path("resident/notices/",views.reactapp,name="nilaya_notices"),

path("resident/memberregistration/",views.reactapp,name="nilaya_memberregistration"),

path("members/",views.reactapp,name="nilaya_members"),
