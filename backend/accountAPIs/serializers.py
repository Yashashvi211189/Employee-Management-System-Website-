...
class CreateAccountWithPhoneSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        send_mail(
            'Registration successful! : Nilaya',
            "We are glad to welcome you to Nilaya.",
...
class CreateOTPAccountWithPhoneSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        send_mail('OTP : Nilaya', str(otp), settings.DEFAULT_FROM_EMAIL, [username])
