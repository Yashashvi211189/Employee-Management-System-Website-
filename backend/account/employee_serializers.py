...
class EmployeeProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'profile_pic',
            'status', 'is_active', 'has_password', 'requires_password_change', 'current_project', 'current_project_title', 'documents',
...
class EmployeeLoginSerializer(serializers.Serializer):
    ...
    Accepts email + the temporary/current password assigned in Django admin.
    """
    ...
    def validate(self, attrs):
        ...
        # Find user by employee login email.
        try:
...
class EmployeeTicketCommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'ticket', 'text', 'links', 'attachments', 'author', 'created_at']
        read_only_fields = ['id', 'author', 'attachments', 'created_at']
