...
def contact_api_submission(request):
    ...
    if request.method == 'POST':
        try:
            ...
            email_subject = f"Nilaya Contact: {subject}" if subject else "New Contact Form Submission"
            
            # Plain text version
            text_message = f"""
                New Contact Form Submission - Nilaya Website
                ...
                This message was sent from the Nilaya website contact form.
                            """
            ...
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <h2 style="color: #2563eb;">New Contact Form Submission - Nilaya</h2>
...
def contactus_view(request, *args, **kwargs):
      ...
      if request.POST:
          ...
          if form.is_valid():
              ...
              send_mail(
                  f"Nilaya Contact: {data.get('subject') or 'Website submission'}",
