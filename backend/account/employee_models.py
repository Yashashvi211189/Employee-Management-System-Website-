...
class OTPVerification(models.Model):
    ...
    otp_code = models.CharField(max_length=128)  # 6-digit OTP
...
class EmployeeTicketAttachment(models.Model):
    ...
    comment = models.ForeignKey('EmployeeTicketComment', on_delete=models.CASCADE, null=True, blank=True, related_name='attachments')
...
class EmployeeTicketNotification(models.Model):
    KIND_CHOICES = [
        ('mention', 'Mention'),
    ...
    ticket = models.ForeignKey(EmployeeTicket, on_delete=models.CASCADE, related_name='notifications')
    comment = models.ForeignKey(EmployeeTicketComment, on_delete=models.CASCADE, null=True, blank=True, related_name='notifications')
    recipient_user = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name='employee_ticket_notifications')
    recipient_employee = models.ForeignKey(EmployeeProfile, on_delete=models.CASCADE, null=True, blank=True, related_name='ticket_notifications')
    actor = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='sent_employee_ticket_notifications')
    kind = models.CharField(max_length=20, choices=KIND_CHOICES, default='comment')
    title = models.CharField(max_length=255)
    message = models.TextField(blank=True)
    mention_label = models.CharField(max_length=120, blank=True)
